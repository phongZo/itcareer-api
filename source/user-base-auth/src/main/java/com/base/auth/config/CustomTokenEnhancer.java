...
public class CustomTokenEnhancer implements TokenEnhancer {
    ...
    public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
        ...
        if(authentication.getOAuth2Request().getGrantType() != null){
            ...
            if(grantType.equals(SecurityConstant.GRANT_TYPE_STUDENT) || grantType.equals(SecurityConstant.GRANT_TYPE_EDUCATOR)){
                String email = authentication.getOAuth2Request().getRequestParameters().get("email");
                additionalInfo = getAdditionalUserInfo(email, grantType);
            }
        }
    ...
    private Map<String, Object> getAdditionalUserInfo(String email, String grantType) {
        Map<String, Object> additionalInfo = new HashMap<>();
